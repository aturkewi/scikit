...
# Passed classifier - discrete
# Regression classifier - continous
# Stratified folds - Folds that have been selected such that there are roughly an equal amount of each classifier in each fold
